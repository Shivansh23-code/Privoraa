    ...
    <footer>
      <div className="wrap">
        <div className="foot-grid">
          <div className="foot-brand">
            ...
            <div className="foot-soc">
              ...
              <a href="#" aria-label="Vedix on LinkedIn">
                <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                href="https://github.com/Shivansh23-code/Vedix"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Vedix on GitHub"
              >
                <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="foot-base">
          <span>
            © <span id="yr">{new Date().getFullYear()}</span> Vedix. Sealed with care.
          </span>
