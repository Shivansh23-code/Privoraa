 ...
 * one sets the chat mode to that persona.
 */
export default function ProAssistants() {
  ...
  return (
    <div>
      <p className="mb-1.5 flex items-center gap-1.5 px-1 text-[11px] font-semibold uppercase tracking-wide text-[var(--accent-primary)]">
